Website developed for a university project, in which we constructed a basic musical instrument that would receive the commands (notes) written in the computer prompt. 
